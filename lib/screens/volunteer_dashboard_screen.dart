...
class _VolunteerDashboardScreenState extends State<VolunteerDashboardScreen> {
  ...
  Future<void> _loadActivities() async {
    ...
    try {
      ...
      // This will print the error to your console so we know exactly what is wrong!
      print("FETCH ERROR: $e"); 
    }
  }
  ...
  Future<void> _pickAvatar() async {
    ...
    if (result == null) return; // Removed the .path check
    ...
    try {
      ...
      // Use the helper! Ensure your bucket is named EXACTLY 'avatars' in Supabase.
      final baseUrl = await UploadHelper.uploadFile(
        file: file,
        bucketName: 'avatar',
        folderPath: path,
      );
  ...
  int get _totalPoints => _activities.fold(
    0,
    (sum, a) =>
        sum + (int.tryParse(a['points_claimed']?.toString() ?? '0') ?? 0),
  );
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const ActivityPointsScreen(),
                      ),
                    ),
                ...
                Container(
                  ...
                  child: const Column(
                    children: [
                      ...
                      Text(
                        'Log your first activity in the AICTE tab.',
